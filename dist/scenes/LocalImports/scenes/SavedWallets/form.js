...
exports.default = (props) => {
    const { savedWallets, touched, errors, isSubmitting, values, setFieldValue, status, setStatus } = props;
    return (react_1.default.createElement(formik_1.Form, null,
        react_1.default.createElement(antd_1.Form.Item, { label: "Saved encrypted keys" },
            react_1.default.createElement(antd_1.Select, { defaultValue: values.encryptedKey, onChange: val => setFieldValue("encryptedKey", val) }, savedWallets.map(item => {
        ...
        !underscore_1.default.isEmpty(status) && status.errorMsg ? (react_1.default.createElement(antd_1.Form.Item, null,
